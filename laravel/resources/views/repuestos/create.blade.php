            ...
            <div class="col">
                ...
                <div class="alert alert-info mt-4" role="alert">
                    ...
                    <ul>
                        ...
                        <li><strong>Descripción del repuesto:</strong> Ingrese una descripción del repuesto.</li>
                        <li><strong>Número de parte del Repuesto:</strong> Ingrese el número de parte asociado al repuesto.</li>
                    </ul>
                </div>
                ...
                <div class="card mt-3">
                    <div class="card-header">
                        Agregar Información del Repuesto
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('repuestos.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nombre_repuesto" id="nombre_repuesto" class="form-control" value="{{ old('nombre_repuesto') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="descripcion_repuesto" id="descripcion_repuesto" class="form-control" value="{{ old('descripcion_repuesto') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="part_number_repuesto" id="part_number_repuesto" class="form-control" value="{{ old('part_number_repuesto') }}" required>
